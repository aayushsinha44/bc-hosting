...
function initWeb3() {
	if (typeof web3 !== "undefined") {
      ...
      App.web3Provider = new Web3.providers.HttpProvider('https://rinkeby.infura.io/v3/f590b0b9374e44389e4a12797c06d44f');
			...
			model.getEntries(fileInput.files[0], function(entries) {
				...
				entries.forEach(function(entry) {
					...
					if(extension.length > 1){
						...
						li.appendChild(a);
						getResponse(entry,li,a,extension,changedFileName);   // uploading content to ipfs
					}
					else
						entries_length -= 1;
